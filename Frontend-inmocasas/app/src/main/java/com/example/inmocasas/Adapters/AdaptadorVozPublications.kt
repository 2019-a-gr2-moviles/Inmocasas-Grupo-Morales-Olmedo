...
import com.example.inmocasas.NavegacionUsuario.VozActivity
import com.example.inmocasas.R
import com.example.inmocasas.dto.Publicacion

class AdaptadorVozPublications(
    private val listaPublicaciones:List<Publicacion>,
    private val contexto: VozActivity,
    private val recyclerview: androidx.recyclerview.widget.RecyclerView
):androidx.recyclerview.widget.RecyclerView.Adapter<AdaptadorVozPublications.MyViewHolder>() {
    ...
    override fun onBindViewHolder(myViewHolder: AdaptadorVozPublications.MyViewHolder, position: Int) {
