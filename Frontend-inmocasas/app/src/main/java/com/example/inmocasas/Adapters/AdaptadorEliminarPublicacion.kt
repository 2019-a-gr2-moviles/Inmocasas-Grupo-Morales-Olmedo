...
import com.example.inmocasas.NavegacionUsuario.EliminarPublicacionActivity
import com.example.inmocasas.R
import com.example.inmocasas.dto.Publicacion

class AdaptadorEliminarPublicacion (private val listaPublicaciones:List<Publicacion>,
                                    private val contexto: EliminarPublicacionActivity,
                                    private val recyclerview: RecyclerView
): androidx.recyclerview.widget.RecyclerView.Adapter<AdaptadorEliminarPublicacion.MyViewHolder>() {
    ...
    inner class MyViewHolder(view: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            val layout = view.findViewById(R.id.publicaciones_eliminar_layout) as RelativeLayout
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): MyViewHolder {
        val itemView = LayoutInflater
            .from(p0.context)
            .inflate(
                R.layout.publicaciones_eliminar_layout,
                p0,
                false
            )
    ...
    override fun onBindViewHolder(myViewHolder: AdaptadorEliminarPublicacion.MyViewHolder, position: Int) {
